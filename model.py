...
class TransformerModel(nn.Module):
    ...
    def init_weights(self):
        ...
        self.decoder_geo.bias.data.zero_()
        self.decoder_geo.weight.data.uniform_(-initrange, initrange)
    def forward(self, src, src_mask):
        ...
        return out_poi, out_cat,out_geo,x


class TransformerModeltime(nn.Module):
    def __init__(self, num_poi, num_cat,num_geo, embed_size, nhead, nhid, nlayers, dropout=0.5):
        super(TransformerModeltime, self).__init__()
        from torch.nn import TransformerEncoder, TransformerEncoderLayer
        self.model_type = 'Transformer'
        self.pos_encoder = PositionalEncoding(embed_size, dropout)
        encoder_layers = TransformerEncoderLayer(embed_size, nhead, nhid, dropout)
    ...
    def forward(self, src, src_mask):
        ...
        out_cat = self.decoder_cat(x)
        # out_geo = self.decoder_geo(x)
        return out_poi, out_cat,out_time,x